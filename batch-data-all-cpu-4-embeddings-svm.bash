...
python analysis-classical-run.py --dataset "cap-us-court" --sample_interval 100 500 1000 2500 5000 5426 --method "classical_ml" --model "SVM" --n_cross_val_final 3 --hyperparam_study_date 20220709 --zeroshot --vectorizer "embeddings"
