...
### 100 & 500 run
## base-nli
python analysis-transf-hyperparams.py --learning_rate 1e-6 5e-4 --epochs 3 39 --batch_size 8 16 32 --n_trials 15 --n_trials_sampling 9 --n_trials_pruning 6 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 100 500 --method "nli" --model "MoritzLaurer/DeBERTa-v3-base-mnli-fever-docnli-ling-2c" --carbon_tracking
...
## base-standard
python analysis-transf-hyperparams.py --learning_rate 1e-6 5e-4 --epochs 40 100 --batch_size 8 16 32 --n_trials 15 --n_trials_sampling 9 --n_trials_pruning 6 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 100 500 --method "standard_dl" --model "microsoft/deberta-v3-base" --carbon_tracking
...
### 1000 run
## base-nli
python analysis-transf-hyperparams.py --learning_rate 1e-6 5e-4 --epochs 3 39 --batch_size 8 16 32 --n_trials 15 --n_trials_sampling 9 --n_trials_pruning 6 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 1000 --method "nli" --model "MoritzLaurer/DeBERTa-v3-base-mnli-fever-docnli-ling-2c" --carbon_tracking
...
## base-standard
python analysis-transf-hyperparams.py --learning_rate 1e-6 5e-4 --epochs 30 100 --batch_size 8 16 32 --n_trials 15 --n_trials_sampling 9 --n_trials_pruning 6 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 1000 --method "standard_dl" --model "microsoft/deberta-v3-base" --carbon_tracking
...
### 2500 run
## base-nli
python analysis-transf-hyperparams.py --learning_rate 1e-6 5e-4 --epochs 3 39 --batch_size 16 32 --n_trials 14 --n_trials_sampling 7 --n_trials_pruning 5 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 2500 --method "nli" --model "MoritzLaurer/DeBERTa-v3-base-mnli-fever-docnli-ling-2c" --carbon_tracking
...
## base-standard
python analysis-transf-hyperparams.py --learning_rate 1e-6 5e-4 --epochs 30 100 --batch_size 16 32 --n_trials 14 --n_trials_sampling 7 --n_trials_pruning 5 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 2500 --method "standard_dl" --model "microsoft/deberta-v3-base" --carbon_tracking
...
### 5000 run
## base-nli
python analysis-transf-hyperparams.py --learning_rate 1e-7 9e-4 --epochs 3 39 --batch_size 16 32 --n_trials 14 --n_trials_sampling 7 --n_trials_pruning 5 --n_cross_val_hyperparam 2 --context --dataset "cap-sotu" --sample_interval 5000 --method "nli" --model "MoritzLaurer/DeBERTa-v3-base-mnli-fever-docnli-ling-2c" --carbon_tracking
