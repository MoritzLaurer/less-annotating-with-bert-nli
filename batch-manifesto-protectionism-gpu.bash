...
## mini-nli
#python analysis-transf-hyperparams.py --learning_rate 1e-6 9e-4 --epochs 1 16 --batch_size 8 16 --n_trials 10 --n_trials_sampling 6 --n_trials_pruning 4 --n_cross_val_hyperparam 2 --context --dataset "manifesto-protectionism" --sample_interval 100 500 1000 --method "nli" --model "MoritzLaurer/xtremedistil-l6-h256-mnli-fever-anli-ling-binary" --carbon_tracking
#python analysis-transf-run.py --dataset "manifesto-protectionism" --sample_interval 100 500 1000 --method "nli" --model "MoritzLaurer/xtremedistil-l6-h256-mnli-fever-anli-ling-binary" --n_cross_val_final 3 --hyperparam_study_date 20220422 --carbon_tracking
## mini-standard
#python analysis-transf-hyperparams.py --learning_rate 1e-6 9e-4 --epochs 40 80 --batch_size 8 16 --n_trials 10 --n_trials_sampling 6 --n_trials_pruning 4 --n_cross_val_hyperparam 2 --context --dataset "manifesto-protectionism" --sample_interval 100 500 1000 --method "standard_dl" --model "microsoft/xtremedistil-l6-h256-uncased" --carbon_tracking
#python analysis-transf-run.py --dataset "manifesto-protectionism" --sample_interval 100 500 1000 --method "standard_dl" --model "microsoft/xtremedistil-l6-h256-uncased" --n_cross_val_final 3 --hyperparam_study_date 20220422 --carbon_tracking
